        ...
        <aside className={`${isMobile ? 'hidden' : 'w-64'} bg-white border-r border-border shadow-sm`}>
          <div className="h-full flex flex-col">
            <div className="px-6 py-6 border-b border-border">
              <h1 className="text-xl font-bold text-noor-brown">Noor Admin</h1>
            </div>
                ...
                <Link
                  ...
                  className={`flex items-center px-3 py-2 rounded-md transition-colors ${
                    location.pathname === item.path
                      ? 'bg-noor-yellow-light text-noor-brown'
        ...
        {isMobile && (
          <div className="fixed top-0 left-0 right-0 z-20 bg-white border-b border-border shadow-sm">
            <div className="flex items-center justify-between px-4 py-3">
              <h1 className="text-lg font-bold text-noor-brown">Noor Admin</h1>
              <Button 
                variant="ghost" 
                size="sm" 
