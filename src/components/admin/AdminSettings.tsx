...
const AdminSettings = () => {
  ...
  const saveColorChanges = () => {
    ...
    // Update the noor- prefixed colors in Tailwind
    ...
    document.documentElement.style.setProperty('--noor-yellow-light', colors.primaryLight);
    document.documentElement.style.setProperty('--noor-olive-light', colors.accentLight);
  ...
  const resetToDefault = () => {
    ...
    document.documentElement.style.setProperty('--noor-yellow-light', defaultWithDerivatives.primaryLight);
    document.documentElement.style.setProperty('--noor-olive-light', defaultWithDerivatives.accentLight);
