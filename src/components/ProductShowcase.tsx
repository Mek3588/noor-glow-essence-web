...
const ProductShowcase = () => {
  ...
  useEffect(() => {
    ...
    if (productItems.length === 0 && !isLoading) {
      setProducts([
        {
          id: 'default-1',
          title: 'Miracle Growth Hair Oil',
          description: 'Our signature hair & scalp oil for growth',
        ...
        },
        {
          ...
          description: 'Deep nourishing treatment for healthy scalp',
  ...
  return (
    <section className="w-full py-12 md:py-20 bg-gradient-to-b from-white to-green-50">
      <div className="max-w-screen-2xl mx-auto px-4">
        {isLoading ? (
          ...
          <>
            <div className="flex flex-col md:flex-row items-center justify-between mb-10 md:mb-16">
              <div className="text-center md:text-left md:max-w-lg">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-green-800 mb-4 slide-in">
                  Our Products
                </h2>
                <p className="text-gray-600 text-lg max-w-2xl slide-in">
                  Discover our natural hair care collection made with premium ingredients 
              ...
              <div className="mt-6 md:mt-0 flex items-center gap-2 slide-in">
                ...
                <span className="text-green-800 font-medium">Natural & Effective</span>
              </div>
            </div>
            ...
            <div className="w-full overflow-hidden -mx-4">
              ...
              >
                  ...
                  {products.map((product) => (
                    <CarouselItem key={product.id} className="pl-2 md:pl-4 sm:basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/5">
                      <div className="group h-full rounded-xl overflow-hidden bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1">
                        <div className="aspect-square w-full overflow-hidden relative">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center">
                            <div className="p-4 text-white text-center w-full transform translate-y-10 group-hover:translate-y-0 transition-transform duration-300">
                              <span className="inline-block px-4 py-1 bg-green-700/80 rounded-full text-xs backdrop-blur-sm">
                                View Details
                              </span>
                            </div>
                          </div>
                        ...
                        <div className="p-5">
                          <h3 className="font-semibold text-lg mb-1 text-green-800 group-hover:text-green-700 transition-colors duration-300">{product.title}</h3>
                ...
                <div className="flex justify-center mt-8 gap-4">
                  <CarouselPrevious className="relative static left-0 right-auto translate-y-0 rounded-full bg-white/70 backdrop-blur-sm border-green-700 text-green-700 hover:bg-green-700 hover:text-white" />
                  <CarouselNext className="relative static right-0 left-auto translate-y-0 rounded-full bg-white/70 backdrop-blur-sm border-green-700 text-green-700 hover:bg-green-700 hover:text-white" />
                </div>
              </Carousel>
            </div>
          </>
